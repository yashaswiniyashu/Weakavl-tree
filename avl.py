...
class BST:
    ...
    def dele(self,s):
        ...
        self.D.delete(self.D.search(s))
    def pred(self,x):
        self.D.val(self.D.predecessor(self.D.search(x)))
    def succes(self,x):
        self.D.val(self.D.successor(self.D.search(x)))
...
def main():
    ...
    print('maximum is')
    b.max()
    print('enter the number to find its predecessor:')
    num=int(input())
    b.pred(num)
    print("enter the number to find its successor:")
    num1=int(input())
    b.succes(num1)
